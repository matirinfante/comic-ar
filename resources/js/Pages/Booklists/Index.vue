                    ...
                    <div
                        ...
                        <div class="flex flex-wrap relative">
                            ...
                            <div class="absolute right-2 bottom-0">
                                <span v-if="book.classification == 'Guía de lectura'" class="px-2 text-xs text-white bg-gradient-to-r from-cyan-500 to-blue-500">{{book.classification}}</span>
                                <span v-if="book.classification == 'Crossover'" class="px-2 text-xs text-white bg-gradient-to-br from-green-400 to-blue-600">{{book.classification}}</span>
                                <span v-if="book.classification == 'Personal'" class="px-2 text-xs text-white bg-gradient-to-r from-purple-500 to-pink-500">{{book.classification}}</span>
                            </div>
                        </div>
                        </Link>
                    </div>
