            ...
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <div class="mx-6 z-40 border-2 rounded-lg relative">
                    <div class="w-full pb-8 sm:px-0 bg-slate-700 rounded-t-lg h-48">
                        <div class="flex justify-start w-1/5 absolute left-2 md:left-10 top-2 md:top-10 border-2">
                            <img class="h-25" :src="volume[0].coverImage" :alt="volume[0].title" />
                            <p class="text-white text-2xl font-bold ml-6">{{volume[0].title}}</p>
                        </div>
                    </div>
                    <div class="flex">
                    ...
                    <div class="border-y-2 bg-white pt-0 pb-10 md:pt-20 flex flex-col md:flex-row justify-between">
                        <div class="md:w-6/12">
                            <h2 class="text-lg font-bold text-gray-600 ml-10 mt-20">
                                Argumento
                            </h2>
