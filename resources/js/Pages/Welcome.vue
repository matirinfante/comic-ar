...
<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-white dark:bg-gray-100 sm:items-center sm:pt-0">
        <!-- <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block dark:bg-blue-200">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center h-40">
                ...
                <div v-else class="text-center w-80 transition delay-300">
                    <p class="font-semibold bg-gradient-to-r bg-clip-text text-transparent from-fuchsia-500 via-purple-500 to-blue-500 animate-text">{{quote}}</p>
