            ...
            <div class="" id="profile">
                <div class="relative" id="user">
                    ...
                    <div class="absolute left-[104px] sm:left-64 md:left-40 lg:left-72 xl:left-80 2xl:left-[365px]" id="pic-name">
                        <img class="contrast-125 rounded-full -mt-14 ml-3 md:ml-0 h-24 sm:-mt-14 sm:h-28 sm:w-28 md:-mt-16 md:h-32 md:w-32 lg:-mt-20 lg:h-36 lg:w-36 xl:-mt-20 xl:h-40 xl:w-40 2xl:-mt-24 2xl:h-44 2xl:w-44 border-[2px] border-white bg-white drop-shadow-xl" :src="user.profile_photo_url">
